...
HD_PWD='C:/Users/adilr/Documents/fpga/finalproject/finalproject.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pattern_rec.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pattern_rec.tcl
