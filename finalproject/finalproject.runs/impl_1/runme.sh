...
HD_PWD='C:/Users/adilr/Documents/fpga/finalproject/finalproject.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pattern_rec.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pattern_rec.tcl -notrace
